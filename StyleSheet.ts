...
/** Update these with values to match the design template */
...
export const textStyles: TextStyles = {
  ...
  B8: {
    ...
    fontSize: 42,
    lineHeight: 42 * 1.1,
    paddingTop: 42 - 42 * 0.11,
  },
  B7: {
    fontFamily: fontFamilies.Bold,
    fontSize: 40,
    lineHeight: 40 * 1.1,
    paddingTop: 40 - 40 * 0.11,
  },
  B6: {
    fontFamily: fontFamilies.Bold,
    fontSize: 38,
    lineHeight: 38 * 1.1,
    paddingTop: 38 - 38 * 0.11,
  },
  B5: {
    fontFamily: fontFamilies.Bold,
    fontSize: 36,
    lineHeight: 36 * 1.1,
    paddingTop: 36 - 36 * 0.11,
  },
  B4: {
    fontFamily: fontFamilies.Bold,
    fontSize: 34,
    lineHeight: 34 * 1.1,
    paddingTop: 34 - 34 * 0.11,
  },
  B3: {
    fontFamily: fontFamilies.Bold,
    fontSize: 32,
    lineHeight: 32 * 1.1,
    paddingTop: 32 - 32 * 0.11,
  },
  B2: {
    fontFamily: fontFamilies.Bold,
    fontSize: 30,
    lineHeight: 30 * 1.1,
    paddingTop: 30 - 30 * 0.11,
  },
  B1: {
    fontFamily: fontFamilies.Bold,
    fontSize: 28,
    lineHeight: 28 * 1.1,
    paddingTop: 28 - 28 * 0.11,
  },
  BS: {
    fontFamily: fontFamilies.Bold,
    fontSize: 26,
    lineHeight: 26 * 1.1,
    paddingTop: 26 - 26 * 0.11,
  },
  BXS: {
    fontFamily: fontFamilies.Bold,
    fontSize: 24,
    lineHeight: 24 * 1.1,
    paddingTop: 24 - 24 * 0.11,
  },
  BXS1: {
    fontFamily: fontFamilies.Bold,
    fontSize: 22,
    lineHeight: 22 * 1.1,
    paddingTop: 22 - 22 * 0.11,
  },
  BXS2: {
    fontFamily: fontFamilies.Bold,
    fontSize: 20,
    lineHeight: 20 * 1.1,
    paddingTop: 20 - 20 * 0.11,
  },
  BXS3: {
    fontFamily: fontFamilies.Bold,
    fontSize: 18,
    lineHeight: 18 * 1.1,
    paddingTop: 18 - 18 * 0.11,
  },
  BXS4: {
    fontFamily: fontFamilies.Bold,
    fontSize: 16,
    lineHeight: 16 * 1.1,
    paddingTop: 16 - 16 * 0.11,
  },
  BXS5: {
    fontFamily: fontFamilies.Bold,
    fontSize: 14,
    lineHeight: 14 * 1.1,
    paddingTop: 14 - 14 * 0.11,
  },
  BXS6: {
    fontFamily: fontFamilies.Bold,
    fontSize: 12,
    lineHeight: 12 * 1.1,
    paddingTop: 12 - 12 * 0.11,
  },
  BXS7: {
    fontFamily: fontFamilies.Bold,
    fontSize: 10,
    lineHeight: 10 * 1.1,
    paddingTop: 10 - 10 * 0.11,
  },
  D14: {
  ...
  R12: {
    ...
    fontSize: 72,
    lineHeight: 72 * 1.4,
    paddingTop: 72 - 72 * 0.14,
  },
  R11: {
    fontFamily: fontFamilies.Regular,
    fontSize: 60,
    lineHeight: 60 * 1.4,
    paddingTop: 60 - 60 * 0.14,
  },
  R10: {
    fontFamily: fontFamilies.Regular,
    fontSize: 48,
    lineHeight: 48 * 1.4,
    paddingTop: 48 - 48 * 0.14,
  },
  R9: {
    fontFamily: fontFamilies.Regular,
    fontSize: 44,
    lineHeight: 44 * 1.4,
    paddingTop: 44 - 44 * 0.14,
  },
  R8: {
    fontFamily: fontFamilies.Regular,
    fontSize: 42,
    lineHeight: 42 * 1.4,
    paddingTop: 42 - 42 * 0.14,
  },
  R7: {
    fontFamily: fontFamilies.Regular,
    fontSize: 40,
    lineHeight: 40 * 1.4,
    paddingTop: 40 - 40 * 0.14,
  },
  R6: {
    fontFamily: fontFamilies.Regular,
    fontSize: 38,
    lineHeight: 38 * 1.4,
    paddingTop: 38 - 38 * 0.14,
  },
  R5: {
    fontFamily: fontFamilies.Regular,
    fontSize: 36,
    lineHeight: 36 * 1.4,
    paddingTop: 36 - 36 * 0.14,
  },
  R4: {
    fontFamily: fontFamilies.Regular,
    fontSize: 34,
    lineHeight: 34 * 1.4,
    paddingTop: 34 - 34 * 0.14,
  },
  R3: {
    fontFamily: fontFamilies.Regular,
    fontSize: 32,
    lineHeight: 32 * 1.4,
    paddingTop: 32 - 32 * 0.14,
  },
  R2: {
    fontFamily: fontFamilies.Regular,
    fontSize: 30,
    lineHeight: 30 * 1.4,
    paddingTop: 30 - 30 * 0.14,
  },
  R1: {
    fontFamily: fontFamilies.Regular,
    fontSize: 28,
    lineHeight: 28 * 1.4,
    paddingTop: 28 - 28 * 0.14,
  },
  RS: {
    fontFamily: fontFamilies.Regular,
    fontSize: 26,
    lineHeight: 26 * 1.4,
    paddingTop: 26 - 26 * 0.14,
  },
  RXS: {
    fontFamily: fontFamilies.Regular,
    fontSize: 24,
    lineHeight: 24 * 1.4,
    paddingTop: 24 - 24 * 0.14,
  },
  RXS1: {
    fontFamily: fontFamilies.Regular,
    fontSize: 22,
    lineHeight: 22 * 1.4,
    paddingTop: 22 - 22 * 0.14,
  },
  RXS2: {
    fontFamily: fontFamilies.Regular,
    fontSize: 20,
  ...
  RXS5: {
    ...
    fontSize: 14,
    lineHeight: 14 * 1.3,
    paddingTop: 14 - 14 * 0.13,
  },
  RXS6: {
    fontFamily: fontFamilies.Regular,
    fontSize: 12,
    lineHeight: 12 * 1.3,
    paddingTop: 12 - 12 * 0.13,
  },
  RXS7: {
    fontFamily: fontFamilies.Regular,
    fontSize: 10,
    lineHeight: 10 * 1.3,
    paddingTop: 10 - 10 * 0.13,
  },
  L14: {
